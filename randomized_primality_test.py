...
def randomized_primality_test(n):
    ...
    This is an example of a Monte Carlo class randomized algorithm, since it is 
    correct with high probability of at least 50% for non-Carmichael number composites.
    It can at best reject ~n~ if it is NOT prime, but cannot definitively identify a prime.
